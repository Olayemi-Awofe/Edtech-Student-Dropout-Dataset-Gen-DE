...
df = spark.read.format("delta").load(
    "Tables/gold/student_dropout_features"
).cache()
...
target_col = re.sub('[^A-Za-z0-9_]+', '_', "dropout_probability")
...
mlflow.set_experiment("Notebook1-AutoMLExperiment")
...
with mlflow.start_run(nested=True, run_name="Notebook1-AutoMLModel"):
    automl.fit(
        X_train=X_train, 
...
registered_model = mlflow.register_model(model_uri=model_path, name="Notebook1-AutoMLModel")
...
model_name = "Notebook1-AutoMLModel"
